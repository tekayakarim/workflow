...
@Component({
  selector: 'app-new-demandes',
  templateUrl: './new-demandes.component.html',
  styleUrls: ['./new-demandes.component.scss']
})
export class NewDemandesComponent implements OnInit {
