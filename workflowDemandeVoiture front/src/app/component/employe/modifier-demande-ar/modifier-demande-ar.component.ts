...
@Component({
  selector: "app-modifier-demande-ar",
  templateUrl: "./modifier-demande-ar.component.html",
  styleUrls: ["./modifier-demande-ar.component.scss"],
})
export class ModifierDemandeArComponent implements OnInit {
  id: String;
